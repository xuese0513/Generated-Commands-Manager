# setup string flattening processor
    ...
    setblock ~ ~ ~3 chain_command_block[facing=east]{auto:1b,TrackOutput:1b,UpdateLastExecution:0b,Command:"execute as 0-0-0-0-0 run function _gcm_:flattener/slicer/concat_length"}
